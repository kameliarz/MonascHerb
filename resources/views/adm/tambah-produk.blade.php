<x-layout>
    ...
    <div class="mx-auto max-w-5xl px-6 py-8">
        <div class="rounded-2xl bg-white p-8 shadow-md">
            <h2 class="mb-8 text-xl font-bold text-gray-800">Tambah Produk</h2>
            ...
            <form action="/admin/produk" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 gap-8 md:grid-cols-2">
                @csrf
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <div>
                            <label for="komposisi" class="mb-1 block text-sm font-medium text-gray-700">Komposisi Produk</label>
                            <textarea
                                id="komposisi"
                                name="komposisi"
                                rows="3"
